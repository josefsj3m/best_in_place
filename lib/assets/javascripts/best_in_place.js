...
BestInPlaceEditor.prototype = {
    ...
    initOptions: function () {
        ...
        self.element.parents().each(function () {
            ...
            self.mask = self.mask || typeof($parent.data("bipMask")) !== 'undefined' ? $parent.data("bipMask").toString() : $parent.data("bipMask");
            self.unmaskToSend = self.unmaskToSend || $parent.data("bipUnmaskToSend");
        });
        ...
        self.mask = typeof(self.element.data("bipMask")) !== 'undefined' ? self.element.data("bipMask").toString() : self.mask;
        self.unmaskToSend = self.element.data("bipUnmaskToSend");

        if (self.unmaskToSend == null){
            self.unmaskToSend = BestInPlaceEditor.defaults.unmaskToSend;
        }
    ...
    requestData: function () {
        ...
        if (this.mask){
            if (this.unmaskToSend && changedValue != ""){
                var tempVal = Inputmask.unmask(this.getValue(), { alias: this.mask});
                var elValue = tempVal == null ? "" : tempVal;
            }else {
                var elValue = this.getValue();
            }
        }else{
            var elValue = this.getValue();
        }
        ...
        data += "&" + this.objectName + '[' + this.attributeName + ']=' + encodeURIComponent(elValue);
    ...
    "input": {
        activateForm: function () {
            ...
            if(this.mask)
            {
                ...
                this.element.find("input[type='text']").inputmask(this.mask);
            }
